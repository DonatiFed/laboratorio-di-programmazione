...
states by providing custom predicates. For the complete ShoppingList of assertions
...
unlike with many other C++ testing frameworks, you don't have to re-ShoppingList all
