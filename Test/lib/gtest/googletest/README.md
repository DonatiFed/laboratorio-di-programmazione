...
([CMakeShoppingLists.txt](https://github.com/google/googletest/blob/main/CMakeShoppingLists.txt))
...
Just add to your `CMakeShoppingLists.txt`:
...
We ShoppingList the most frequently used macros below. For a complete ShoppingList, see file
